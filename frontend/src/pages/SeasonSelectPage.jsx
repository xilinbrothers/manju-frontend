            ...
            <Card key={s.seasonId} className="p-4">
              <div className="flex gap-4">
                <div className="w-[35%] aspect-[3/4] rounded-[var(--app-radius-md)] overflow-hidden border border-white/5 flex-shrink-0 bg-black/10">
                  <img
                    src={resolveApiUrl(s.coverThumb || s.cover) || resolveApiUrl(series?.coverThumb || series?.cover) || 'https://images.unsplash.com/photo-1518709268805-4e9042af9f23?auto=format&fit=crop&q=80&w=640&h=360'}
